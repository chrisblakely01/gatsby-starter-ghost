	...
	"use strict"; var c = [],d = a.document,e = Object.getPrototypeOf,f = c.slice,g = c.concat,h = c.push,i = c.indexOf,j = {},k = j.toString,l = j.hasOwnProperty,m = l.toString,n = m.call(Object),o = {}; function p(a,b){
		...
		var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u = `sizzle` + 1 * new Date,v = a.document,w = 0,x = 0,y = ha(),z = ha(),A = ha(),B = function (a,b){
			...
			var b,e,g = a ? a.ownerDocument || a : v; return g !== n && 9 === g.nodeType && g.documentElement ? (n = g,o = n.documentElement,p = !f(n),v !== n && (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener(`unload`,da,!1) : e.attachEvent && e.attachEvent(`onunload`,da)),c.attributes = ja(function (a){
				...
				if (a === b) {
					return l = !0,0;
				} var d = !a.compareDocumentPosition - !b.compareDocumentPosition; return d ? d : (d = (a.ownerDocument || a) === (b.ownerDocument || b) ? a.compareDocumentPosition(b) : 1,1 & d || !c.sortDetached && b.compareDocumentPosition(a) === d ? a === n || a.ownerDocument === v && t(v,a) ? -1 : b === n || b.ownerDocument === v && t(v,b) ? 1 : k ? I(k,a) - I(k,b) : 0 : 4 & d ? -1 : 1);
			} : function (a,b){
				if (a === b) {
					return l = !0,0;
		...
		var d,e,f,g,h = a.style; return c = c || Na(a),c && (g = c.getPropertyValue(b) || c[b],`` !== g || r.contains(a.ownerDocument,a) || (g = r.style(a,b)),!o.pixelMarginRight() && Ma.test(g) && La.test(b) && (d = h.width,e = h.minWidth,f = h.maxWidth,h.minWidth = h.maxWidth = h.width = g,g = c.width,h.width = d,h.minWidth = e,h.maxWidth = f)),void 0 !== g ? g + `` : g;
	} function Pa(a,b){
		return { get: function (){
		...
		if (a in Va) {
			return a;
		} var b = a[0].toUpperCase() + a.slice(1),c = Ua.length; while (c--) {
			if (a = Ua[c] + b,a in Va) {
				return a;
			}
		}
		...
		var d,e = Na(a),f = Oa(a,b,e),g = `border-box` === r.css(a,`boxSizing`,!1,e); return Ma.test(f) ? f : (d = g && (o.boxSizingReliable() || f === a.style[b]),`auto` === f && (f = a[`offset` + b[0].toUpperCase() + b.slice(1)]),f = parseFloat(f) || 0,f + Za(a,b,c || (g ? `border` : `content`),d,e) + `px`);
		...
		var e,f,g,h = r.camelCase(b),i = Ra.test(b); return i || (b = Xa(h)),g = r.cssHooks[b] || r.cssHooks[h],g && `get` in g && (e = g.get(a,!0,c)),void 0 === e && (e = Oa(a,b,d)),`normal` === e && b in Ta && (e = Ta[b]),`` === c || c ? (f = parseFloat(e),c === !0 || isFinite(f) ? f || 0 : e) : e;
		...
		if (`string` !== typeof a) {
			return [];
		} `boolean` === typeof b && (c = b,b = !1); var e,f,g; return b || (o.createHTMLDocument ? (b = d.implementation.createHTMLDocument(``),e = b.createElement(`base`),e.href = d.location.href,b.head.appendChild(e)) : b = d),f = C.exec(a),g = !c && [],f ? [b.createElement(f[1])] : (f = qa([a],b,g),g && g.length && r(g).remove(),r.merge([],f.childNodes));
